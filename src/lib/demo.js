...
{id:'m1',code:'NL0001',category:'NL',name:'Hạt điều vỡ',manufacturer:'Nông sản Bình Phước',supplier:'Nông sản Việt',unit:'kg'},
{id:'m2',code:'NL0002',category:'NL',name:'Yến mạch cán',manufacturer:'Green Farm',supplier:'Green Farm',unit:'kg'},
{id:'m3',code:'PL0001',category:'PL',name:'Chai thủy tinh 300ml',manufacturer:'Thủy tinh Việt',supplier:'Bao bì An Phát',unit:'chai'},
{id:'m4',code:'NL0003',category:'NL',name:'Đường phèn',manufacturer:'Đường Biên Hòa',supplier:'Nông sản Việt',unit:'kg'}],lots:[
